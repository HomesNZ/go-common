...
func (mr *MockCacheMockRecorder) GetBool(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBool", reflect.TypeOf((*MockCache)(nil).GetBool), key)
}
...
func (mr *MockCacheMockRecorder) GetString(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCache) SetExpiry(key string, val interface{}, expireTime int) error {
	m.ctrl.T.Helper()
...
func (m *MockCache) SetExpiryTime(key string, val interface{}, expireTime time.Time) error {
	m.ctrl.T.Helper()
